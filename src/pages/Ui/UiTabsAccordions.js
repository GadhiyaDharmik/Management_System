...
const UiTabsAccordions = () => {
  ...
  const [activeTab1, setactiveTab1] = useState("Five")
  ...
  const [activeTabJustify, setactiveTabJustify] = useState("Five")
              ...
              <Card>
                <CardBody>
                  ...
                  <TabContent activeTab={activeTab} className="p-3 text-muted">
                    ...
                    <TabPane tabId="Two" className="p-3">
                      <p className="mb-0">
              ...
              <Card>
                <CardBody>
                  ...
                  <Nav tabs className="nav-tabs-custom nav-justified">
                    <NavItem>
                      <NavLink
                        style={{ cursor: "pointer" }}
                        className={classnames({
                          active: activeTabJustify === "Five",
                        })}
                        onClick={() => {
                          toggleCustomJustified("Five")
                        }}
                      >
                        <span className="d-block d-sm-none">
                          <i className="fas fa-home"></i>
                    ...
                    <NavItem>
                      <NavLink
                        style={{ cursor: "pointer" }}
                        className={classnames({
                          active: activeTabJustify === "Six",
                        })}
                        onClick={() => {
                          toggleCustomJustified("Six")
                        }}
                      >
                        <span className="d-block d-sm-none">
                          <i className="far fa-user"></i>
                    ...
                    <NavItem>
                      <NavLink
                        style={{ cursor: "pointer" }}
                        className={classnames({
                          active: activeTabJustify === "Seven",
                        })}
                        onClick={() => {
                          toggleCustomJustified("Seven")
                        }}
                      >
                        <span className="d-block d-sm-none">
                          <i className="far fa-envelope"></i>
                    ...
                    <NavItem>
                      <NavLink
                        style={{ cursor: "pointer" }}
                        className={classnames({
                          active: activeTabJustify === "Eight",
                        })}
                        onClick={() => {
                          toggleCustomJustified("Eight")
                        }}
                      >
                        <span className="d-block d-sm-none">
                  ...
                  <TabContent activeTab={activeTabJustify}>
                    <TabPane tabId="Five" className="p-3">
                      <p className="mb-0">
                        Raw denim you probably haven&apos;t heard of them jean
                        shorts Austin. Nesciunt tofu stumptown aliqua, retro
                        synth master cleanse. Mustache cliche tempor,
                    ...
                    <TabPane tabId="Six" className="p-3">
                      <p className="mb-0">
                        Food truck fixie locavore, accusamus mcsweeney&apos;s
                        marfa nulla single-origin coffee squid. Exercitation +1
                        labore velit, blog sartorial PBR leggings next level wes
                    ...
                    <TabPane tabId="Seven" className="p-3">
                      <p className="mb-0">
                        Etsy mixtape wayfarers, ethical wes anderson tofu before
                        they sold out mcsweeney&apos;s organic lomo retro fanny
                        pack lo-fi farm-to-table readymade. Messenger bag
                    ...
                    <TabPane tabId="Eight" className="p-3">
                      <p className="mb-0">
