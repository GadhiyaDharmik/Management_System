...
function discountPage() {
  ...
  const summarys = {
    id: id ? parseInt(id) : discountList.length + 1,
    ...
    specificCustomersValue: id
      ? updateDiscount[0].specificCustomersValue
        ...
        : []
      : [],
    specificCustomerSegmentsListValue: id
      ? updateDiscount[0].specificCustomerSegmentsListValue
        ? updateDiscount[0].specificCustomerSegmentsListValue
        : []
      : [],
    specificCustomersListValue: id
      ? updateDiscount[0].specificCustomersListValue
        ? updateDiscount[0].specificCustomersListValue
        : []
      : [],
